...
((global) => {
    ...
    const chartColorKeys = Object.keys(chartColors);
    window.randomColor = () => {
        const randIndex = Math.round(Samples.utils.rand(0, chartColorKeys.length - 1));
        const randKey = chartColorKeys[randIndex];
        return window.chartColors[randKey]
    };
